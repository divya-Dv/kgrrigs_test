...
<title>Kgr Rigs | Thank You</title>
...
<section style="background-image: url(images/kgr/12.jpg);">
  <div class="container">

    <div class="row align-items-center">
      
      <div class="col-lg-8 col-md-8 offset-md-3 offset-lg-3 col-sm-12 col-xs-12 md-mt-3 text-center pl30">
        <div class="tyd">
        <div class="ico">
          <i class="fas fa-check-circle"></i>
        </div>
        <h2 class="title ty">Thank <span> You !!</span></h2>
        
        <p class="lead text-center typ">Your Response has been submitted. We will get back to you shortly....</p>
        <p style="text-align:center;">If Brochure not downloaded <a href="images/kgr/pdf/KGR-DTH-1000-1500-2000.pdf" download="images/kgr/pdf/KGR-DTH-1000-1500-2000.pdf" id="link"> click here</a></p>
        <a class="btn btn-theme btn-sm" href="index.php"><span>Back to Home</span></a>
      </div>
    </div>
