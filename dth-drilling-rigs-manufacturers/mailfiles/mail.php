...
if($_POST['keyword']!=NULL){ $keyword=$_POST['keyword']; }
...
$subject = 'Enquiry for KGR Rigs';

$message = "<!DOCTYPE HTML--><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <tr>
            <td width="100%" align="center" valign="top">
                ...
                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="container" bgcolor="ffffff">
                    ...
                    <tr bgcolor="ffffff">
                        <td height="40" style="text-align:center;"> Enquiry For KGR Rigs </td>
                    </tr>
                    <tr>
                        <td>
                            <table border="0" width="560" align="center" cellpadding="0" cellspacing="0" class="container-middle">
...
<tr>
                                            ...
                                            <tr>
                                                <td mc:edit="subtitle1" class="main-subheader" style="color: #555; font-size: 13px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                    <multiline>
                                                        <i>Product Interested: ".$project."</i>
                                                    </multiline>
                                                </td>
                                            </tr>
...
CURLOPT_POST =&gt; true,
CURLOPT_POSTFIELDS =&gt; [
'secret' =&gt; '6LceZ8MbAAAAAOAHC5dLBtv9FC4VxPC8uHIGWNiq',
'response' =&gt; $_POST["token"],
...
echo "Captcha Verification Failed";
	...
	$mail = new PHPMailer();		
    	$mail-&gt;From      = 'noreply@kgrrigs.com';		
    	$mail-&gt;FromName  = "TD-G Rank-Enquiry";		
    	$mail-&gt;Subject   = $subject;		
    	$mail-&gt;Body      = $message;		
    	$mail-&gt;SetFrom( "noreply@kgrrigs.com", 'TD-G Rank-Enquiry');
    
            
            // $mail-&gt;AddAddress('tejaswini@grank.co.in', 'KGR Rigs');

$mail-&gt;AddAddress('sales@kgrrigs.com', 'KGR Rigs Landing');
$mail-&gt;AddBCC('leadtest.grank@gmail.com','KGR Rigs Landing');     
$mail-&gt;AddBCC('sowmya@grank.co.in','KGR Rigs Landing'); 
$mail-&gt;AddBCC('maheshwari@grank.co.in','KGR Rigs Landing'); 
$mail-&gt;AddBCC('anjali@grank.co.in', 'KGR Rigs Landing');
