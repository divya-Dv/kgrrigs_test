...
if($_POST['countryCode']!=NULL){ $countryCode=$_POST['countryCode']; }
...
$subject = 'Download Brochure for KGR Rigs';
        ...
        <tr>
            <td width='100%' align='center' valign='top'>
                ...
                <table width='600' border='0' cellpadding='0' cellspacing='0' align='center' class='container' bgcolor='ffffff'>
                    ...
                    <tr bgcolor='ffffff'>
                        <td height='40' style='text-align:center;'> Download Brochure for KGR Rigs </td>
                    </tr>
                    <tr>
                        <td>
                            <table border='0' width='560' align='center' cellpadding='0' cellspacing='0' class='container-middle'>
...
// $mail->AddAddress('divya.perugu05@gmail.com', 'KGR Rigs');   
$mail->AddAddress('kgrrigs@gmail.com', 'KGR Rigs');

  
     $mail->AddCC('leadtest@grank.co.in','KGR Rigs');     
    //  $mail->AddAddress('shreya@grank.co.in','KGR Rigs');     
...
if($mail->send())
    {    
		header('Location: http://www.kgrrigs.com/thank-you.php');
    }
