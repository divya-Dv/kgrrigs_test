...
<meta name="description" content="DTH hammers in India with KGR Rigs. Our high-performance drilling solutions redefine efficiency and precision, perfect for diverse geological condition">
<link rel="canonical" href="https://www.kgrrigs.com/dth-hammers.php">

<title>DTH Hammers In India - KGR Rigs</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-12 ml-auto mr-auto">
        <h1 class="title mb-0 phseo">DTH Hammers In India</h1>
      </div>
    </div>
    <nav aria-label="breadcrumb" class="page-breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">DTH Hammers In India</li>
      </ol>
    </nav>
  </div>
</section>
    ...
    <div class="row">
      ...
      <div class="col-lg-7 col-md-7 md-mt-3">
        <div class="team-description">
          <h2 class="title phd z-index-1 mb-4">DTH Hammers In India</h2>
...
<p class="line-h-2 mb-0 md-mt-5 mt-20">See also <a href="excavator-mounted-drill-rigs-manufacturers.php">Excavator Mounted Drill Rigs Manufacturers</a></p>
