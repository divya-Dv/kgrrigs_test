...
$mail-&gt;AddAddress('sales@kgrrigs.com', 'KGR Rigs');
$mail-&gt;AddBCC('seo.grank@gmail.com','KGR Rigs');     
$mail-&gt;AddBCC('leadtest@grank.co.in','KGR Rigs'); 
$mail-&gt;AddBCC('anjali@grank.co.in', 'KGR Rigs');
...
if($mail-&gt;send())
{    
header('Location: http://www.kgrrigs.com/thankyou.php');
}
